...
public class SalaryBean {
	...
	public String getSalReleasePerson() {
		return salReleasePerson;
	}
	public void setSalReleasePerson(String salReleasePerson) {
		this.salReleasePerson = salReleasePerson;
	}
	public String getSalReleaseDate() {
		return salReleaseDate;
	}
	public void setSalReleaseDate(String salReleaseDate) {
		this.salReleaseDate = salReleaseDate;
	}
	public String getSalCheckPerson() {
		return salCheckPerson;
	}
	public void setSalCheckPerson(String salCheckPerson) {
		this.salCheckPerson = salCheckPerson;
	}
	public Date getSalCheckDate() {
		return salCheckDate;
	}
	public void setSalCheckDate(Date salCheckDate) {
		this.salCheckDate = salCheckDate;
	}
